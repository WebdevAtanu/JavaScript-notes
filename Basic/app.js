...
var marks = {
    ...
    ram: 50,
    sam: 50.5
}; //This is object variable/non primitive datatype
...
// destructuring
let dearr = ["ram", "sam"];
let [v1, v2] = dearr; //The array elements will asign to the variables 
console.log(v1);
console.log(v2);
...
let sumres = sum(...arr3); //"..." is mandatory
console.log(sumres);
